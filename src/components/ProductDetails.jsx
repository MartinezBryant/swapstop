...
function ProductDetail({ product, setShowTradeModal, isLoggedIn, setShowLoginModal }) {
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  <div className="flex">
                    {[...Array(5)].map((_, i) => (
                      <span key={i} className={i < product.owner.rating ? "text-yellow-400" : "text-gray-300"}>
                        ★
                      </span>
                    ))}
                  </div>
